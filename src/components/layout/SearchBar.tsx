		...
		>
			...
			<span className="h-full w-5/6 relative">
				...
				<input
					...
					draggable={false}
					ref={inputRef}
					className={` py-3 px-5  border-[.15rem] border-accent bg-transparent text-[1.4rem] rounded-lg border-r-0 rounded-r-none focus-visible:ring-0 ${active && "border-2 border-r-0 border-foreground/80"
			...
			<Button
				...
				variant="ghost"
				type="submit"
				className={`h-full w-1/6  border-2 border-accent  rounded-l-none ${active ? "border-accent-foreground/80" : ""
					}`}
			>
